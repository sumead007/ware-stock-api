using WareStockApi.Application.TodoItems.Commands.CreateTodoItem;
using WareStockApi.Application.TodoItems.Commands.UpdateTodoItem;
using WareStockApi.Application.TodoItems.Commands.UpdateTodoItemDetail;
using WareStockApi.Application.TodoLists.Commands.CreateTodoList;
using WareStockApi.Domain.Entities;
using WareStockApi.Domain.Enums;

namespace WareStockApi.Application.FunctionalTests.TodoItems.Commands;
