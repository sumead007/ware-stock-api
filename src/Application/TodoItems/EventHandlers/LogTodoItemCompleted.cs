using WareStockApi.Domain.Events;
using Microsoft.Extensions.Logging;

namespace WareStockApi.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("WareStockApi Domain Event: {DomainEvent}", notification.GetType().Name);
